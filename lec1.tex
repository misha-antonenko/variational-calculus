...
\begin{lemma}[the tangent space in terms of curves]
...
\begin{theorem}[general form of the first variation]
...
Let $\Omega \ss \R^k$ have $C^1$ boundary, and $u \col \Cl \Omega \to \R^n$ be a $C^1$ function. Consider
...
\begin{lemma}[Ostrogradsky--Gauss formula]
...
\begin{theorem}[Euler-Ostrogradsky equations]
